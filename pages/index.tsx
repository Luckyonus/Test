            ...
            <main className={styles.main}>
                ...
                <div className={styles.grid}>
                    ...
                    <a href="https://alcashzone.com/category/adsense-approval/" className={styles.card}>
                        ...
                        <p>Here you can find how to become a master in AdSense approval!</p>
                    </a>
                    ...
                    >
                        <h2>Blogging &rarr;</h2>
                        <p>Here you can find the source to become a master in blogging.</p>
                    </a>
                    ...
                    >
                        <h2>News &rarr;</h2>
                        <p>
                            Here you can find Showviz news and other national and international news.
                        </p>
                    </a>
                </div>
            </main>
